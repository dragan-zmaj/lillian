...
#ifndef CYPHAL_MESSAGES_MOTOR_CONTROL_1_0_INCLUDED_
...
// +-------------------------------------------------------------------------------------------------------------------+
#define cyphalMessages_motorControl_1_0_FULL_NAME_             "cyphalMessages.motorControl"
#define cyphalMessages_motorControl_1_0_FULL_NAME_AND_VERSION_ "cyphalMessages.motorControl.1.0"
...
///                 @see cyphalMessages_motorControl_1_0_SERIALIZATION_BUFFER_SIZE_BYTES_
///
...
static inline int8_t cyphalMessages_motorControl_1_0_serialize_(
    const cyphalMessages_motorControl_1_0* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
...
///
/// @returns Negative on error, zero on success.
static inline int8_t cyphalMessages_motorControl_1_0_deserialize_(
    cyphalMessages_motorControl_1_0* const out_obj, const uint8_t* buffer, size_t* const inout_buffer_size_bytes)
{
...
static inline void cyphalMessages_motorControl_1_0_initialize_(cyphalMessages_motorControl_1_0* const out_obj)
{
    if (out_obj != NULL)
    {
        size_t size_bytes = 0;
        const uint8_t buf = 0;
        const int8_t err = cyphalMessages_motorControl_1_0_deserialize_(out_obj, &buf, &size_bytes);
...
#endif
#endif // CYPHAL_MESSAGES_MOTOR_CONTROL_1_0_INCLUDED_
